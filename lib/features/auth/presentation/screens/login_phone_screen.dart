...
class _LoginPhoneScreenState extends State<LoginPhoneScreen>
  ...
  Widget _logoOrb() =>
      _orbitalLogo(88, isVerySmall: false, isSmallScreen: false);
  ...
  Widget _glassButton({
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: kLoginBlue.withOpacity(0.30),
            blurRadius: isSmallScreen ? 16 : 24,
            offset: Offset(0, isSmallScreen ? 7 : 12),
          ),
          BoxShadow(
            color: kLoginPink.withOpacity(0.20),
            blurRadius: isSmallScreen ? 18 : 26,
            offset: Offset(0, isSmallScreen ? 8 : 14),
          ),
        ],
      ),
      child: Material(
  ...
  Widget _biometricButton() {
    ...
    return AnimatedCrossFade(
      ...
      crossFadeState: _shouldShowBiometricButton
                                  ...
                                  AutofillGroup(
                                    child: Column(
                                      children: [
                                        ...
                                        SizedBox(
                                          height: isVerySmall ? 8 : gapMedium,
                                        ),
                                        _buildGlassInput(
...
class _LoginOrbitPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
      rectA,
      -math.pi * 0.82 + progress * math.pi * 2,
      math.pi * 0.38,
      false,
      accentPaint,
    );
  ...
  InputDecoration _inputDecoration(
    ...
    return InputDecoration(
      ...
      focusedBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(19),
        borderSide: const BorderSide(color: kLoginViolet, width: 1.5),
      ),
    );
  }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: success
            ...
            : const Color(0xFFFFF4F2).withOpacity(0.97),
        border: Border.all(
          color: success ? const Color(0xFFB8EBC8) : const Color(0xFFFFD7D0),
        ),
      ),
      child: Text(
        text,
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: kLoginBlue.withOpacity(0.24),
                        blurRadius: 20,
                ...
                if (_requestMessage != null) ...[
                  const SizedBox(height: 13),
                  _messageBox(_requestMessage!, success: _requestSuccess),
                ],
                const SizedBox(height: 20),
                Container(
                  width: double.infinity,
                ...
                if (_confirmMessage != null) ...[
                  const SizedBox(height: 13),
                  _messageBox(_confirmMessage!, success: _confirmSuccess),
                ],
